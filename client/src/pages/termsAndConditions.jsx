                                ...
                                <article>
                                    ...
                                    <div className="gray terms-and-conditions">
                                        ...
                                        <div className="mobile-container" style={{ display: showMobile == 2 ? 'block' : 'none' }}>
                                            ...
                                            <p></p>
                                            <p>
                                                If at any time you are in any doubt about how to place bets or otherwise use the Service you should refer back to these Terms or contact our customer service department (<em><strong>Customer Service Department)</strong></em> at "<a href="mailto:support@payperwin.co">support@payperwin.co</a>".
                                            </p>
                                        </div>
                                            ...
                                            <ol className="sub hide-number" style={{ counterReset: "item 4" }} start="5">
                                                <li>
                                                    <ol className="sub show-number" start="5">
                                                        ...
                                                        <li>You must inform us as soon as you become aware of any errors with respect to your Account. Customers have the right to self-exclude themselves from payperwin.com. These requests have to be received from the Customer's Registered Email Address and have to be sent to <a href="mailto:support@payperwin.co">support@payperwin.co</a>.</li>
                                                        <li>Customers may set limitations on the amount they may wager and lose. Such request has to be sent from the Customer's Registered Email Address to <a href="mailto:support@payperwin.co">support@payperwin.co</a>.</li>
                                                        ...
                                                        <li>Should you wish to close your account with us, please send an email from your Registered Email Address to <a href="mailto:support@payperwin.co">support@payperwin.co</a>.</li>
                                                    </ol>
                                                </li>
                                            </ol>
                                            <p></p>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 7" }} start="8">
                                                        <li>
                                                            <ol className="sub show-number" start="8">
                                                                ...
                                                                <li>Should you wish to withdraw funds but your account is either inaccessible, dormant, locked or closed, please contact our Customer Service Department at <a href="mailto:support@payperwin.co">support@payperwin.co</a>.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 9" }} start="10">
                                                        <li>
                                                            <ol className="sub show-number" start="10">
                                                                ...
                                                                <li>All limitations mentioned above is administered and initiated by contacting the Customer Service Department at <a href="mailto:support@payperwin.co">support@payperwin.co</a>.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 12" }} start="13">
                                                        <li>
                                                            <ol className="sub show-number" start="13">
                                                                <li>All communications and notices to be given under these Terms by you to us shall be sent to <a href="mailto:support@payperwin.co">support@payperwin.co</a></li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 21" }} start="22">
                                                        <li>
                                                            <ol className="sub show-number" start="22">
                                                                <li>If you have any concerns or questions regarding these Terms you should contact our Customer Service Department via email at <a title="Email CSD" href="mailto:support@payperwin.co?subject=Email%20CSD">support@payperwin.co</a>.</li>
                                                                ...
                                                                <li>Any Customer of the Service who has any concerns or questions regarding these Terms regarding the settlement of any payperwin.com market should contact our Customer Service Department at <a title="Email CSD" href="mailto:support@payperwin.co?subject=Email%20CSD"> support@payperwin.co</a> using their Registered Email Address.</li>
                                                                <li>If a Customer is not satisfied with how a bet has been settled then the Customer should provide details of their grievance to our Customer Service Department via email at <a href="mailto:support@payperwin.co">support@payperwin.co</a>. We shall use our reasonable endeavours to respond to queries of this nature within a few days (and in any event we intend to respond to all such queries within 28 days of receipt).</li>
                                                                <li>Disputes must be lodged within three (3) days from the date the wager in question has been decided. No claims will be honored after this period. The Customer is solely responsible for their Account transactions. Complaints/disputes have to be sent to <a title="Email CSD" href="mailto:support@payperwin.co?subject=Email%20CSD">support@payperwin.co</a> and must be sent from the Customer's Registered Email Address.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 28" }} start="29">
                                                        <li>
                                                            <ol className="sub show-number" start="29">
                                                                ...
                                                                <li>Any dispute related to the sports betting product shall be emailed to: <a title="Email CSD" href="mailto:support@payperwin.co?subject=Email%20CSD">support@payperwin.co</a>.</li>
                                                ...
                                                <ol className="sub hide-number" style={{ counterReset: "item 29" }} start="30">
                                                    <li>
                                                        <ol className="sub show-number" start="30">
                                                            ...
                                                            <li>Any dispute related to the casino product shall be emailed to <a href="support@payperwin.co">support@payperwin.co</a>.</li>
                                                        </ol>
                                                    </li>
                                                </ol>
                                            </ul>
