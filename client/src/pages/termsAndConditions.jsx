                                ...
                                <article className="content">
                                    ...
                                    <div className="gray terms-and-conditions">
                                        ...
                                        <div className="mobile-container" style={{ display: showMobile == 1 ? 'block' : 'none' }}>
                                            <p></p>
                                            <p>
                                                <strong>These terms and conditions and the documents referred and linked to below (the "<em>Terms</em>") set out the basis upon which the website operated under the URL “www.pinnacle.com” (the "Website") and its related or connected services (collectively, the "<em>Service</em>") will be provided to you.</strong>
                                            </p>
                                            <p></p>
                                            <p>
                                            ...
                                            <p></p>
                                            <p>
                                                The company trades as 'Pinnacle'.
                                            </p>
                                            <p>
                                                Impyrial Holdings Ltd, 8A Pitmans Alley Main Street, Gibraltar GX11 1AA.
                                                <br />
                                                Pinnacle.com operates with the licence of Ragnarok Corporation N.V., Pletterijweg 43, Willemstad, Curaçao, which is licensed by the government of Curacao under the Licence 8048/JAZ2013-013 issued for the provision of sports betting and casino. Pinnacle will only communicate with Customers by email to their registered email address (the "<em><strong>Registered Email Address</strong></em>") as provided when opening your Pinnacle Account: Communication from Pinnacle will be issued through the following mail only: <a href="mailto:customerservice@pinnacle.com"> "customerservice@pinnacle.com"</a>.
                                            </p>
                                            <p></p>
                                            <p></p>
                                        </div>
                                        ...
                                        <div className="mobile-container" style={{ display: showMobile == 2 ? 'block' : 'none' }}>
                                            ...
                                            <p></p>
                                            <p>
                                                If at any time you are in any doubt about how to place bets or otherwise use the Service you should refer back to these Terms or contact our customer service department (<em><strong>Customer Service Department)</strong></em> at "<a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a>".
                                            </p>
                                        </div>
                                            ...
                                            <ol className="sub hide-number" style={{ counterReset: "item 4" }} start="5">
                                                <li>
                                                    <ol className="sub show-number" start="5">
                                                        <li>We accept Accounts in multiple currencies, please refer to <a href="/en/payments">https://www.pinnacle.com/en/payment-options</a>. All Account balances and transactions appear in the currency selected when the Account was originally opened. We do not give credit for the use of the Service.</li>
                                                        ...
                                                        <li>You must inform us as soon as you become aware of any errors with respect to your Account. Customers have the right to self-exclude themselves from pinnacle.com. These requests have to be received from the Customer's Registered Email Address and have to be sent to <a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a>.</li>
                                                        <li>Customers may set limitations on the amount they may wager and lose. Such request has to be sent from the Customer's Registered Email Address to <a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a>.</li>
                                                        ...
                                                        <li>Should you wish to close your account with us, please send an email from your Registered Email Address to <a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a>.</li>
                                                    </ol>
                                                </li>
                                            </ol>
                                            <p></p>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 6" }} start="7">
                                                        <li>
                                                            <ol className="sub show-number" start="7">
                                                                ...
                                                                <li>Fees and charges may apply to your deposits and withdrawals. Fee and charge details can be found here: <a href="/en/payments">https://www.pinnacle.com/en/payment-options</a>.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 7" }} start="8">
                                                        <li>
                                                            <ol className="sub show-number" start="8">
                                                                <li>You may withdraw any or all of your Account Balance within the transaction maximums as shown on the Website here: <a href="/en/payments">https://www.pinnacle.com/en/payment-option</a>. Note that fees may apply as outlined in 7.2.</li>
                                                                ...
                                                                <li>All withdrawals must be made to the original debit card, credit card, bank account, method of payment used to make the payment to your pinnacle.com Account. We may, and always at our own discretion, allow you to withdraw to a payment method from which your original deposit did not originate. This will always be subject to additional security checks.</li>
                                                                <li>Should you wish to withdraw funds but your account is either inaccessible, dormant, locked or closed, please contact our Customer Service Department at <a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a>.</li>
                                                                <li>Pinnacle reserves the right to carry out additional verification procedures for any withdrawal exceeding the equivalent of €2,000 and reserves the right to carry out such verification procedures in the case of lower withdrawal amounts.</li>
                                                            </ol>
                                                        </li>
                                                    </ol>
                                                </ul>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 8" }} start="8">
                                                        <li>
                                                            <ol className="sub show-number" start="8">
                                                                ...
                                                                <li>Pinnacle may suspend, block or close an Account and withhold funds if requested to do so in accordance with obligations for the Prevention of Money Laundering.</li>
                                                                <li>Pinnacle’s obligations towards responsible gaming and AML legislation trump commercial conditions.</li>
                                                            </ol>
                                                        </li>
                                                    </ol>
                                                </ul>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 9" }} start="10">
                                                        <li>
                                                            <ol className="sub show-number" start="10">
                                                                <li>Pinnacle offers a procedure by which you may exclude yourself from gaming. This exclusion shall be offered for all games offered and across all means by which Pinnacle provides its services. An exclusion may only be set:
                                                                    <div className="list-alike">
                                                                        <p><span>i</span>upon the request of the player; or</p>
                                                                        <p><span>ii</span>by Pinnacle if there are sufficient reasons to indicate that you may have a gambling problem.</p>
                                                                    </div>
                                                                </li>
                                                                ...
                                                                <li>All limitations mentioned above is administered and initiated by contacting the Customer Service Department at <a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a>.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 10" }} start="11">
                                                        <li>
                                                            <ol className="sub show-number" start="11">
                                                                ...
                                                                <li>Pinnacle has the right to limit, cancel and refuse bets in case they are considered to be too large or if we see that the betting pattern of the player takes place in such a way that the system is being abused.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 11" }} start="12">
                                                        <li>
                                                            <ol className="sub show-number" start="12">
                                                                ...
                                                                <li>If for any reason a bet is accepted after a fixture has begun (other than clearly indicated Live In-Play betting) bets will have action unless a material advantage has been gained. Pinnacle reserves the right to void the bet if it determines that an advantage has been gained.</li>
                                                                ...
                                                                <li>Pinnacle reserves the right to remove events, markets and any other product from the website.</li>
                                                                <li>Pinnacle reserves the right to restrict the casino access of any player without prior notice.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 12" }} start="13">
                                                        <li>
                                                            <ol className="sub show-number" start="13">
                                                                <li>All communications and notices to be given under these Terms by you to us shall be sent to <a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a></li>
                                                            ...
                                                            <ol className="sub show-number" start="16">
                                                                <li>If we suspect that you are or receive notification that you are currently under 18 years or were under 18 years (or below the age of majority as stipulated in the laws of the jurisdiction applicable to you) when you placed any bets through the Service your Account will be suspended to prevent you placing any further bets or making any withdrawals from your Account. We will then investigate the matter, including whether you have been betting as an agent for, or otherwise on behalf, of a person under 18 years (or below the age of majority as stipulated in the laws of the jurisdiction applicable to you). If having found that you:
                                                                    <div className="list-alike">
                                                                        ...
                                                                        <p><span style={{ width: '55px' }}>iii.</span>any monies deposited in your pinnacle.com Account which are not winnings will be returned to you.</p>
                                                                    </div>
                                                                </li>
                                                            ...
                                                            <ol className="sub show-number" start="20">
                                                                ...
                                                                <li>Prohibited Behaviour includes, but is not limited to, accessing or using the Service to:
                                                                    <ol className="sub">
                                                                        ...
                                                                        <li>create pinnacle.com Accounts by automated means or under false or fraudulent pretences;</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 21" }} start="22">
                                                        <li>
                                                            <ol className="sub show-number" start="22">
                                                                <li>If you have any concerns or questions regarding these Terms you should contact our Customer Service Department via email at <a title="Email CSD" href="mailto:customerservice@pinnacle.com?subject=Email%20CSD">customerservice@pinnacle.com</a>.</li>
                                                                ...
                                                                <li>Any Customer of the Service who has any concerns or questions regarding these Terms regarding the settlement of any pinnacle.com market should contact our Customer Service Department at <a title="Email CSD" href="mailto:customerservice@pinnacle.com?subject=Email%20CSD"> customerservice@pinnacle.com</a> using their Registered Email Address.</li>
                                                                <li>If a Customer is not satisfied with how a bet has been settled then the Customer should provide details of their grievance to our Customer Service Department via email at <a href="mailto:customerservice@pinnacle.com">customerservice@pinnacle.com</a>. We shall use our reasonable endeavours to respond to queries of this nature within a few days (and in any event we intend to respond to all such queries within 28 days of receipt).</li>
                                                                <li>Disputes must be lodged within three (3) days from the date the wager in question has been decided. No claims will be honored after this period. The Customer is solely responsible for their Account transactions. Complaints/disputes have to be sent to <a title="Email CSD" href="mailto:customerservice@pinnacle.com?subject=Email%20CSD">customerservice@pinnacle.com</a> and must be sent from the Customer's Registered Email Address.</li>
                                                                ...
                                                                <li>The Customer has the right to lodge a complaint by email to Antillephone N.V. via <a href="mailto:complaints@gaminglicences.com">complaints@gaminglicences.com</a> should all efforts to resolve a dispute directly with Pinnacle to the Customer's satisfaction have failed.</li>
                                                            </ol>
                                                        </li>
                                                    </ol>
                                                </ul>
                                                        ...
                                                        <li>
                                                            <ol className="sub show-number" start="28">
                                                                <li>Term of agreement
                                                                    <ol className="sub">
                                                                        <li>These Terms shall remain in full force and effect while you access or use the Service or are a Customer of pinnacle.com. These Terms will survive the termination of your pinnacle.com Account for any reason.</li>
                                                    ...
                                                    <ol className="sub hide-number" style={{ counterReset: "item 28" }} start="29">
                                                        <li>
                                                            <ol className="sub show-number" start="29">
                                                                <li>The sports betting product is operated by Ragnarok Corporation N.V., a limited liability company registered in Curaçao with company registration number 79358, with registered address at Pletterijweg 43, Willemstad, Curaçao.Pinnacle is licensed in Curacao under the Licence 8048/JAZ2013-013.</li>
                                                                <li>Any dispute related to the sports betting product shall be emailed to: <a title="Email CSD" href="mailto:customerservice@pinnacle.com?subject=Email%20CSD">customerservice@pinnacle.com</a>.</li>
                                                ...
                                                <ol className="sub hide-number" style={{ counterReset: "item 29" }} start="30">
                                                    <li>
                                                        <ol className="sub show-number" start="30">
                                                            ...
                                                            <li>Pinnacle is authorised by the suppliers to represent, promote and market the services of the Casino RNG games, the Casino Live games and the Virtual sports. The Casino RNG games, the Casino Live games and the Virtual sports are operated by Ragnarok Corporation N.V., a limited liability company registered in Curaçao with company registration number 79358, with registered address at Pletterijweg 43, Willemstad, Curaçao. Pinnacle is licensed in Curacao under the Licence 8048/JAZ2013-013 for the provision of the Casino RNG games, the Casino Live games and the Virtual sports product.</li>
                                                            <li>Any dispute related to the casino product shall be emailed to <a href="customerservice@pinnacle.com">customerservice@pinnacle.com</a>.</li>
                                                        </ol>
                                                    </li>
                                                </ol>
                                            </ul>
