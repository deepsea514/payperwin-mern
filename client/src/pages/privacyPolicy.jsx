                ...
                <div className="content-container">
                    <div className="privacy-policy-container">
                        ...
                        <div className="mobile-container" style={{ display: showMobile == 3 ? 'block' : 'none' }}>
                            ...
                            <div className="privacy-policy-paragraph">
                                Generally we do not rely on consent as a legal basis for processing your personal data. You have the right to withdraw consent to marketing at any time by contacting us at <a href="mailto:support@payperwin.co">support@payperwin.co</a>.
                            </div>
                            <div className="privacy-policy-paragraph">
                        ...
                        <div className="mobile-container" style={{ display: showMobile == 7 ? 'block' : 'none' }}>
                            ...
                            <div className="privacy-policy-paragraph">
                                Note that we may process your personal data for more than one lawful ground depending on the specific purpose for which we are using your data. Please <a href="mailto:support@payperwin.co">contact us</a> if you need details about the specific legal ground we are relying on to process your personal data where more than one ground has been set out in the table below.
                            </div>
                            <table>
                                <tbody>
                                    <tr>
                        ...
                        <div className="mobile-container" style={{ display: showMobile == 12 ? 'block' : 'none' }}>
                            <div className="privacy-policy-paragraph">
                                Subject to certain limitations on certain rights you have the following rights in relation to your information. You can exercise any of these rights by contacting <a href="mailto:support@payperwin.co">support@payperwin.co</a> naming the right you are exercising along with the reason for your request, if applicable.
                            </div>
                            <div className="right-moved">
                                ...
                                <div className="privacy-policy-paragraph">
                                    <strong>Right to Data Portability:</strong> you have the right to request the personal data you have provided to us. You may make a data portability request by contacting <a href="mailto:support@payperwin.co">support@payperwin.co.</a>
                                </div>
                                <div className="privacy-policy-paragraph">
                                    <strong>Right to Object:</strong> you have the right to object to our processing of your data. It should be noted that this right is not absolute and may be subject to any reasons we have to maintain that information such as our adherence to legal and regulatory obligations. If you wish to object to direct marketing please contact <a href="mailto:support@payperwin.co">support@payperwin.co</a> requesting that you no longer wish to receive marketing materials.
                                </div>
                            </div>
                            <div className="privacy-policy-paragraph">
