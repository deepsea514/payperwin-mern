                    ...
                    <div className="mb-10">
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-45 bg-transparent flex-shrink-0">
                                <SVG src={"/media/svg/files/doc.svg"}></SVG>
                            </div>
                        ...
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-45 bg-transparent flex-shrink-0">
                                <SVG src={"/media/svg/files/pdf.svg"}></SVG>
                            </div>
                            <div className="d-flex flex-column ml-3 mt-2 mb-2">
                                <a
                                    href="#"
                        ...
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-45 bg-transparent flex-shrink-0">
                                <SVG src={"/media/svg/files/xml.svg"}></SVG>
                            </div>
                            <div className="d-flex flex-column ml-3 mt-2 mb-2">
                                <a
                                    href="#"
                        ...
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-45 bg-transparent flex-shrink-0">
                                <SVG src={"/media/svg/files/csv.svg"}></SVG>
                            </div>
                            <div className="d-flex flex-column ml-3 mt-2 mb-2">
                                <a
                                    href="#"
                        ...
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-30  flex-shrink-0">
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url(${"/media/users/300_20.jpg"})`,
                                    }}
                                />
                            </div>
                            <div className="d-flex flex-column ml-3 mt-2 mb-2">
                        ...
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-30  flex-shrink-0">
                                <div
                                    className="symbol-label"
                                    style={{
                                        backgroundImage: `url(${"/media/users/300_15.jpg"}`,
                                    }}
                                />
                            </div>
                            <div className="d-flex flex-column ml-3 mt-2 mb-2">
                        ...
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-30  flex-shrink-0">
                                <div
                                    className="symbol-label"
                                    style={{
                                        backgroundImage: `url(${"/media/users/300_12.jpg"})`,
                                    }}
                                />
                            </div>
                            <div className="d-flex flex-column ml-3 mt-2 mb-2">
                        ...
                        <div className="d-flex align-items-center flex-grow-1 mb-2">
                            <div className="symbol symbol-30  flex-shrink-0">
                                <div
                                    className="symbol-label"
                                    style={{
                                        backgroundImage: `url(${"/media/users/300_16.jpg"})`,
                                    }}
                                />
                            </div>
                            <div className="d-flex flex-column ml-3 mt-2 mb-2">
