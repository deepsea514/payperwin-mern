                                            ...
                                            <div className="symbol symbol-50 symbol-light mr-4">
                                                <span className="symbol-label">
                                                    <span className="svg-icon h-75 align-self-end">
                                                        <SVG src="/media/svg/avatars/001-boy.svg" />
                                                    </span>
                                                </span>
                                            </div>
                                            <div>
                                    ...
                                    <td className="pl-0 py-0">
                                        <div className="d-flex align-items-center">
                                            <div className="symbol symbol-50 symbol-light mr-4">
                                                <span className="symbol-label">
                                                    <span className="svg-icon h-75 align-self-end">
                                                        <SVG src="/media/svg/avatars/018-girl-9.svg" />
                                                    </span>
                                                </span>
                                            </div>
                                            <div>
                                    ...
                                    <td className="pl-0 py-8">
                                        <div className="d-flex align-items-center">
                                            <div className="symbol symbol-50 symbol-light mr-4">
                                                <span className="symbol-label">
                                                    <span className="svg-icon h-75 align-self-end">
                                                        <SVG src="/media/svg/avatars/047-girl-25.svg" />
                                                    </span>
                                                </span>
                                            </div>
                                            <div>
                                    ...
                                    <td className="pl-0 py-0 ">
                                        <div className="d-flex align-items-center">
                                            <div className="symbol symbol-50 symbol-light mr-4">
                                                <span className="symbol-label">
                                                    <span className="svg-icon h-75 align-self-end">
                                                        <SVG src="/media/svg/avatars/014-girl-7.svg" />
                                                    </span>
                                                </span>
                                            </div>
                                            <div>
