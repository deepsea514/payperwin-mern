...
export default class Pinnacle extends React.Component {
    constructor(props) {
        ...
        this.state = {
            loading: false,
            initialValues: null,
            pinnacleSchema: Yup.object().shape({
                pinnacleApiHost: Yup.string()
                    .required("Pinnacle Api Host is required"),
                pinnacleAuthorizationHeader: Yup.string()
        ...
        return (
            <div className="mt-3">
                <div className="d-flex justify-content-between">
                    <h3>Pinnacle</h3>
                    <img src="/images/pinnacle.png" style={{ display: 'block', height: '40px', width: 'auto' }} />
                </div>
                ...
                {!loading && initialValues && <Formik
                    validationSchema={pinnacleSchema}
                        ...
                        return <form onSubmit={formik.handleSubmit} className="p-3">
                            ...
                            <div className="form-group">
                                ...
                                {formik.touched.pinnacleAuthorizationHeader && formik.errors.pinnacleAuthorizationHeader ? (
                                    <div className="invalid-feedback">
                                        {formik.errors.pinnacleAuthorizationHeader}
                                    </div>
                                ) : null}
                            </div>
