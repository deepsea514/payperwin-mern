...
export function TotalPlayers({ className, symbolShape, baseColor, dashboardplayer, categories }) {
    ...
    const getChartOption = (layoutProps) => {
        const options = {
            ...
            yaxis: {
                min: 0,
                max: dashboardplayer.totalplayer,
                labels: {
                    show: false,
                    style: {
                        colors: layoutProps.colorsGrayGray500,
    ...
    useEffect(() => {
        const element = document.getElementById("total_players_chart");
    ...
    }, [layoutProps, dashboardplayer, categories]);
