...
export function ActivePlayers({ className, symbolShape, baseColor, categories, dashboardactiveplayer }) {
    ...
    const getChartOption = (layoutProps) => {
        const options = {
            series: [
                {
                    name: "Active Players",
                    data: dashboardactiveplayer.activeplayers,
                },
            ],
            chart: {
                type: "area",
            ...
            yaxis: {
                min: 0,
                max: dashboardactiveplayer.totalactiveplayer,
                labels: {
                    show: false,
                    style: {
                        colors: layoutProps.colorsGrayGray500,
    ...
    useEffect(() => {
        const element = document.getElementById("active_players_chart");
    ...
    }, [layoutProps, dashboardactiveplayer, categories]);
                ...
                <div className="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                    ...
                    <div className="d-flex flex-column text-right">
                        <span className="text-dark-75 font-weight-bolder font-size-h3">
                            + {dashboardactiveplayer.totalactiveplayer}
                        </span>
