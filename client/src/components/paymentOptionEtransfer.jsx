                ...
                <article className="paymentoption-content mt-5">
                    ...
                    <div>
                        <ul style={{ listStyle: 'number', marginLeft: '20px' }}>
                            ...
                            <li>If the email address and phone number are not correct, please contact support@payperwin.com to update your account information before submitting the request.</li>
