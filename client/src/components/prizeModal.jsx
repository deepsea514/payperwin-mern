...
class PrizeModal extends Component {
    constructor(props) {
        ...
        this.state = {
            pool: [
                { label: "$5", text: "$5 Credit", Score: 17, id: 1, textColor: '#3386f7', textColor2: '#73e6f7' },
                { label: "$25", text: "$25 Credit", Score: 1.49, id: 2, textColor: '#fa33f4', textColor2: '#9a2395' },
                { label: "+2,000", text: "+2,000 Loyalty", Score: 28, id: 3, textColor: '#FFF', textColor2: '#888' },
                { label: "$10", text: "$10 Credit", Score: 2.5, id: 4, textColor: '#Fa3368', textColor2: '#ea636e' },
                { label: "$5", text: "$5 Credit", Score: 17, id: 5, textColor: '#3386f7', textColor2: '#73e6f7' },
                { label: "$100", text: "$100 Credit", Score: 0.01, id: 6, textColor: '#fad239', textColor2: '#f0c329' },
                { label: "+5,000", text: "+5,000 Loyalty", Score: 8, id: 7, textColor: '#FFF', textColor2: '#888' },
                { label: "$25", text: "$25 Credit", Score: 1.49, id: 8, textColor: '#fa33f4', textColor2: '#9a2395' },
                { label: "$5", text: "$5 Credit", Score: 17, id: 9, textColor: '#3386f7', textColor2: '#73e6f7' },
                { label: "$10", text: "$10 Credit", Score: 2.5, id: 10, textColor: '#Fa3368', textColor2: '#ea636e' },
                { label: "+10,000", text: "+10,000 Loyalty", Score: 5, id: 11, textColor: '#FFF', textColor2: '#888' },
                { label: "$100", text: "$100 Credit", Score: 0.01, id: 12, textColor: '#fad239', textColor2: '#f0c329' },
            ],
            used: false,
            remainingTimer: null,
            remainingTime: '',
