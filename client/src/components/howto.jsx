    ...
    return (
      <div className="col-in">
        <div className="how-it-works">
          <h2>
            How
            <img src="/images/logo200-black.png" style={
              {
                width: 200,
                height: 49,
                margin: '0 15px',
          ...
          <Carousel
            ...
            draggable
          >
            <img src="/images/how-step-1.jpg" />
            <img src="/images/how-step-2.jpg" />
            <img src="/images/how-step-3.jpg" />
            <img src="/images/how-step-4.jpg" />
            <img src="/images/how-step-5.jpg" />
          </Carousel>
          <br />
          <br />
          <br />
          ...
          <div>
            ...
            <strong>Get Matched</strong>
              ...
              <div className="how-it-works-info">
                <p>The next step is to have your bet matched with an opposing bettor, there are fours stages of match result:</p>
                <strong>
                Pending Match
                </strong>
                <p>
