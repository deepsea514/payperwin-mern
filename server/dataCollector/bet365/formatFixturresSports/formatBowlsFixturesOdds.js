...
function formatBowlsFixturesOdds(event) {
    ...
    //             line.moneyline = {
    //                 home: convertDecimalToAmericanOdds(parseInt(game_betting_2_way[i + line_count].odds)),
    //                 away: convertDecimalToAmericanOdds(parseInt(game_betting_2_way[i + line_count * 2].odds))
    //             }
    ...
    //                 over: convertDecimalToAmericanOdds(parseInt(game_betting_2_way[i + line_count].odds)),
    //                 under: convertDecimalToAmericanOdds(parseInt(game_betting_2_way[i + line_count * 2].odds)),
    //             })
    //         }
    //     }
    // }
