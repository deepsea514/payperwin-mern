                    ...
                    <div className="row h-100 align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="about-image">
                                <img src="/images/about1.jpg" className="about-img1" alt="about" />

                                <img src="/images/about2.jpg" className="about-img2" alt="about" />

                                <img src="/images/shapes/5.png" className="shape-img" alt="about" />
