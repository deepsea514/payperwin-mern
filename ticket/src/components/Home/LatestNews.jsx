                    ...
                    <div className="row">
                        ...
                        >
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="single-blog-post">
                                    <div className="blog-image">
                                        <Link to="/single-blog"><img src="/images/blog2.jpg" alt="blog" /></Link>
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="single-blog-post">
                                    <div className="blog-image">
                                        <Link to="/single-blog"><img src="/images/blog3.jpg" alt="blog" /></Link>
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="single-blog-post">
                                    <div className="blog-image">
                                        <Link to="/single-blog"><img src="/images/blog4.jpg" alt="blog" /></Link>
